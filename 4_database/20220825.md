...
for movie in movies:
    ...
    mov = Movie()
    mov.director = director_
    mov.genre = genre_
    mov.title = movie[2]
    mov.opening_date = datetime.date(int(movie[3][0:4]), int(movie[3][5:7]), int(movie[3][8:10]))
    mov.running_time = movie[4]
    mov.screening = movie[5]
	mov.save()
```
...
for a in movie:
	print(a.director, a.genre, a.title, a.opening_date, a.running_time, a.screening)
```
...
movie = Movie.objects.all()
for a in movie:
	print(a.director.name, a.genre, a.title, a.opening_date, a.running_time, a.screening)
```
...
movie = Movie.objects.all()
for a in movie:
	print(a.director.name, a.genre.title, a.title, a.opening_date, a.running_time, a.screening)
```
...
movie = Movie.objects.filter(director_id=director.id).filter(genre_id=genre.id).order_by('opening_date')
for a in movie:
    print(a.director.name, a.genre.title, a.title, a.opening_date, a.running_time, a.screening)
```
...
```python
director = Director.objects.get(name='봉준호')
movie = Movie.objects.exclude(director_id=director.id).order_by('opening_date')
for a in movie:
    print(a.director.name, a.genre.title, a.title, a.opening_date, a.running_time, a.screening)
```